...
int maxInUse = 3;    // Number of MAX7219's connected
MaxMatrix m(dIn, cs, clk, maxInUse);

SoftwareSerial Bluetooth(9, 8); // Bluetooth

byte buffer[10];
char incomebyte;
int scrollSpeed = 100;
char text[200] = "HowToMechatronics.com"; // Initial text message
int brightness = 5;
int count = 0;
char indicator;
...
void loop() {
  ...
  Serial.print(F("Previous: "));Serial.print(text); Serial.print(F(" : scrollSpeed : ")); Serial.println(scrollSpeed);

  if (Bluetooth.available()) 
  {   
    Serial.print(F("Bluetooth message: "));
    ...
    // Adjusting the Scrolling Speed
      ...
      Serial.print(F(" : scrollSpeed : ")); Serial.println(scrollSpeed);
    }
